...
function App({ catImages }) {
  ...
  useEffect(() => {
    setTimeout(() => {
      ...
      const maxCatsAux =
        Math.floor(altoGrid / sizeImageCat) *
        Math.floor(gridWidth / sizeImageCat);
    ...
    <div className="container">
      ...
      <div className="cats-grid" id="cats-grid">
        <div className="cat-button" id="cat-button">
          ...
          <p
            className="click-to"
            style={{ visibility: showClickText ? "visible" : "hidden" }}
          >
            <b>Click</b> to make the <del>magic</del> meme happen
          </p>
        </div>
        {renderImages()}
      </div>
      <div className="footer">
        <p>
          Made with <b>PURR</b> by{" "}
          <a href="https://www.instagram.com/juanexplosions/" target="_blank">
            @juanexplosions
          </a>
        </p>
      </div>
